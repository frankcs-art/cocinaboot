...
// IBÉRICOS (Categoría: 'Ibéricos')
{
  ...
  lastUpdated: new Date().toISOString(), location: 'Cámara 1', isPerishable: true,
...
// ACEITES (Categoría: 'Aceites')
{
  ...
  lastUpdated: new Date().toISOString(), location: 'Almacén Seco', isPerishable: false,
...
// LÁCTEOS (Categoría: 'Lácteos')
{
  ...
  lastUpdated: new Date().toISOString(), location: 'Cámara 2', isPerishable: true,
...
// PESCADOS / CONSERVAS (Categoría: 'Pescados')
{
  ...
  lastUpdated: new Date().toISOString(), location: 'Cámara 3', isPerishable: true,
...
},
{
  ...
  lastUpdated: new Date().toISOString(), location: 'Almacén Seco', isPerishable: true,
