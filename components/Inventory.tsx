...
import { Plus, Filter, ArrowUpDown, PlusCircle, History, Trash2, Minus, X } from 'lucide-react';
...
export const Inventory: React.FC<InventoryProps> = ({ inventory, searchTerm, onRecordUsage }) => {
          ...
          <table className="w-full text-left border-separate border-spacing-y-4">
            <thead>
              <tr className="bg-white/2">
                ...
                <th className="px-14 py-6 text-[10px] font-black text-slate-600 uppercase tracking-widest text-center">Stock</th>
