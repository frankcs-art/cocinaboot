...
if (hasCertificates) {
    ...
    http.createServer((req, res) => {
        ...
        const redirectHost = isValidHost ? host : 'localhost';

        res.writeHead(301, { "Location": `https://${redirectHost}:${PORT}${req.url}` });
        res.end();
    }).listen(HTTP_PORT, () => {
    ...
    http.createServer((req, res) => {
        ...
        res.writeHead(301, { "Location": `http://${redirectHost}:${PORT}${req.url}` });
        res.end();
    }).listen(HTTP_PORT, () => {
